...
import { COTTON_PRODUCT } from "@/utils/constant";
...
const CottonProduct = () => {
  ...
  return (
    <>
      ...
      <div>
            <img src="/images/our-prods-banner/cotton.jpg" alt="about-us" className='img-fluid mb-5' />
      </div>
        <Container>
          <Row>
            {COTTON_PRODUCT && COTTON_PRODUCT.map((value, index) => {
                return (
                  <>
                    <Col>
