...
import { PEST_CONTROL_DATA } from "@/utils/constant";
...
const PestControl = () => {
  ...
  return (
    <>
      ...
      <div>
            <img src="/images/our-prods-banner/pest.jpg" alt="about-us" className='img-fluid mb-5' />
      </div>
        <Container>
          <Row>
            {PEST_CONTROL_DATA && PEST_CONTROL_DATA.map((value, index) => {
                return (
                  <>
                    <Col>
